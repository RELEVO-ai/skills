...
-- Copy and paste this into Supabase SQL Editor to create all required tables.
-- Or run: psql $DATABASE_URL -f 001_create_subscriptions_tables.sql
...
-- Unica tabla para tracking de webhooks.
-- PK = idempotency_key.
-- ============================================================
